...
function Projects() {
  return (
    <section id="project-section" className="container flex-row row">
      {/* Project Example 1 */}
      <div id="example1" className="my-2 mx-2 img-container col-md">
      ...
      {/* Project Example 2 */}
      <div id="example2" className="my-2 mx-2 img-container col-md">
      ...
      {/* Project Example 3 */}
      <div id="example3" className="my-2 mx-2 img-container col-md">
      ...
      {/* Project Example 4 */}
      <div id="example4" className="my-2 mx-2 img-container col-md">
